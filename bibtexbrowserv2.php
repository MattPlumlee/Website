...
function bib2links_default($bibentry) {
  ...
  return '<span class="bibmenu">'."<br> &emsp;".implode(" ",$links).'</span>';
}
  ...
  $result = implode(", ",$entry).'.';
    ...
    if ($type=="manual") {
        if ($bibentry->hasField('abstract')) {
          $result .=  '<br> <div class="bibentry-label" style="display: inline">Short Summary: </div><div class="bibentry-abstract" style="display: inline">'.$bibentry->getField("abstract").'</div>';
          }
    }
